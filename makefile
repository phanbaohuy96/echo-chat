...
.PHONY: setup build run test clean asset lang format help coverage_main gen gen_all gen_core gen_data_source gen_main \
	pub_get pub_get_plugins pub_get_core pub_get_main pub_get_backend pub_get_fl_ui pub_get_fl_utils pub_get_fl_theme pub_get_fl_media pub_get_fl_navigation \
	app_identifier reset run_web_dev run_web_staging run_backend test_backend build_web clean_force run_module_generator gen_translation apply_translation
...
help:
	...
	@echo "  make pub_get_backend    - Run dart pub get for EchoChat backend"
	@echo ""
	...
	@echo "  make run_backend        - Run the EchoChat Dart Frog backend"
	...
	@echo "  make test_backend       - Run EchoChat backend tests"
	@echo ""
	@echo "Maintenance:"
