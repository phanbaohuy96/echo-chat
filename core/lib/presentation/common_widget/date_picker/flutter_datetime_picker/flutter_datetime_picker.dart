...
class _DatePickerRoute<T> extends PopupRoute<T> {
  ...
  final CustomDatePickerTheme datePickerTheme;
...
class _DatePickerState extends State<_DatePickerComponent> {
  ...
  Widget build(BuildContext context) {
    final theme = widget.route.datePickerTheme;
  ...
  Widget _renderPickerView(CustomDatePickerTheme theme) {
    ...
    if (widget.route.showTitleActions == true) {
      return Column(
        children: <Widget>[_renderTitleActionsView(theme), itemView],
      );
    }
    return itemView;
  }
      ...
      child: Directionality(
        ...
        child: Row(
          ...
          children: <Widget>[
            ...
            Text(widget.pickerModel.rightDivider(), style: theme.itemStyle),
            Container(
